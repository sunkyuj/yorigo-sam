...
def lambda_handler(event, context):
    ...
    try:
        ...
        requestJSON["user_uid"] = 5001
        recipe_steps = requestJSON.pop("recipe_steps", None)
        total_steps = len(recipe_steps)
        video_length = requestJSON.pop("video_length", 0)  # for demo
        step_length = video_length // total_steps if total_steps else 0  # for demo
        ...
        for step in recipe_steps:  # type of step: dict
            ...
            step["step_start_time"] = step_time
            step_time += step_length  # for demo
            step["step_end_time"] = step_time if step["step_no"] != total_steps else video_length
